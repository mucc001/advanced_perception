...
int main(int argc, char *argv[])
{
        ...
        // //Create two subImages. imgLower contains all pixels with value smaller than the mean. 
        // Mat imgLower;
        // Mat imgHigher;
        // for (int i = 0; i <= img.rows; i++) {
        //     for (int j = 0; j <= img.cols; j++ ) {
        //         if 
        //         sumOfPixels += img.at<uchar>(i, j);
        //     }
        // }
        ...
        for (int i = 0; i <= 256 - mean - 1; i++) {
            ...
            histL.at<float>(i) = hist.at<float>(histIndex);
        }
        ...
        Mat histL_normed;
        Mat histH_normed;
        double totalL = sum(histL)[0];
        double totalH = sum(histH)[0];
        histL.convertTo(histL_normed, CV_32F, 1.0 / totalL);
        histH.convertTo(histH_normed, CV_32F, 1.0 / totalH);
